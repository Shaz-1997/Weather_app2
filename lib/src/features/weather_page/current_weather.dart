...
import 'package:weather_project/src/features/weather_page/current_weather_controller.dart';
import 'package:weather_project/src/features/weather_page/weather_icon_image.dart';
...
class CurrentWeatherContents extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final highAndLow = 'HighTemp:$maxTemp° LowTemp:$minTemp°';
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        WeatherIconImage(iconUrl: data.iconUrl, size: 120),
        Text( "Temperature "+ temp+"°", style: textTheme.displaySmall),
